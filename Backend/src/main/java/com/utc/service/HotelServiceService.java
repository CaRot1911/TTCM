...
public class HotelServiceService implements IHotelServiceService{
    ...
    @Override
    public Page<HotelServices> getListHotelServiceByHotelName(String search, HotelServiceFilter filter, Pageable pageable) {
    ...
    public void deleteHotelService(String hotelName) {
        HotelServices hotelServices = hotelServicesRepository.getHotelServicesByHotelName(hotelName);
